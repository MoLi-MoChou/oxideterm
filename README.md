...
<p align="center">
  <img src="https://img.shields.io/badge/version-2.0.31-blue" alt="Version">
...
## Fork note (MoLi-MoChou)

This fork publishes **Windows-only** releases and points the in-app updater at `MoLi-MoChou/oxideterm` (stable `latest.json` and `updater-beta`). See [docs/development/fork-windows-releases.md](docs/development/fork-windows-releases.md).
