...
pub const STABLE_UPDATE_ENDPOINT: &str =
    "https://github.com/MoLi-MoChou/oxideterm/releases/latest/download/latest.json";
pub const BETA_UPDATE_ENDPOINT: &str =
    "https://github.com/MoLi-MoChou/oxideterm/releases/download/updater-beta/latest.json";
